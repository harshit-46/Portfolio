    ...
    return (
        <main className="bg-black text-white min-h-screen py-16 sm:py-24 relative overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden pointer-events-none">
                ...
                />
                <div className="absolute top-1/4 right-1/4 w-64 h-64 bg-purple-500/5 rounded-full blur-2xl animate-pulse delay-700" />
                <div className="absolute bottom-1/4 left-1/4 w-80 h-80 bg-cyan-500/5 rounded-full blur-3xl animate-pulse delay-1000" />
            </div>
            ...
            <div className="container mx-auto px-4 relative z-10">
                ...
                <section className={`mb-28 sm:mb-40 transition-all duration-1000 delay-400 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
                    <h2 className="text-6xl sm:text-7xl md:text-8xl leading-none font-bold tracking-tight text-left mb-12 bg-gradient-to-r from-white via-gray-200 to-gray-400 bg-clip-text text-transparent">
                        MY<br />EXPERTISE
                    </h2>
