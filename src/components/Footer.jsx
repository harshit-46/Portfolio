    ...
    <div className='h-96 bg-[#1C1C1C] text-white flex flex-col md:flex-row'>
        <div className='border-t w-full md:w-1/3 border-stone-800'>
            ...
            <div id="foot-para" className='text-[#78716C] mt-2'>
                ...
                <p className='copyright pt-36 text-[#A3A3A3]'>Copyright &#169; 2025. All rights reserved.</p>
            </div>
        </div>
        <div className='footer-links w-full md:w-2/3 border-t border-stone-800'>
            <div className='flex flex-col items-start float-left mt-14 pl-44'>
                ...
                <Link to="/home" className=' text-[#A3A3A3] hover:text-white transition duration-200'>Home</Link>
                <Link to="/skills" className=' text-[#A3A3A3] hover:text-white transition duration-200'>Skills</Link>
                <Link to="/education" className=' text-[#A3A3A3] hover:text-white transition duration-200'>Education</Link>
                <Link to="/projects" className=' text-[#A3A3A3] hover:text-white transition duration-200'>Projects</Link>
                <Link to="/contact" className=' text-[#A3A3A3] hover:text-white transition duration-200'>Contact</Link>
            </div>
            <div className='flex flex-col items-start pl-44 mt-14'>
                ...
                className='text-[#A3A3A3] hover:text-white transition duration-200'
                target="_blank" 
                rel="noopener noreferrer">
                    Github
                </a>
...
const Footer = ({ scrollToSection, refs }) => {
    return (
        <div className="h-96 bg-[#1C1C1C] text-white flex flex-col md:flex-row">
            {/* Left Section: Logo & Developer Info */}
            <div className="border-t w-full md:w-1/3 border-stone-800">
