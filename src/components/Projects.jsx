        ...
        <div className="min-h-screen px-4 md:py-24 relative bg-black">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-20 md:px-4 mx-auto">
                <div className="relative inline-block">
                    <h2 className="pro-pax text-white text-2xl md:text-8xl font-bold uppercase">
                        Projects
                    </h2>
                    <div className="absolute left-24 top-2 md:left-28 md:top-12 flex space-x-1 ">
                        {word.split("").map((letter, index) => (
                            <span
                                key={index}
                                className={`pro-heading text-red-500 text-6xl md:text-8xl inline-block opacity-0 animate-fade-in`}
                                style={{
        ...
        <div className="min-h-screen px-4 md:py-24 relative bg-black">
            <div className="flex flex-col md:flex-row md:items-end md:justify-between mb-20 md:px-4 mx-auto">
                <div className="relative inline-block">
                    ...
                    {/* Overlaid animated letters */}
                    <div className="absolute left-24 top-2 md:left-28 md:top-12 flex space-x-1 ">
                        {word.split("").map((letter, index) => (
                            <span
                                key={index}
                                className={`pro-heading text-[#ff0000] text-6xl md:text-8xl inline-block opacity-0 animate-fade-in`}
                                style={{
                                    animationDelay: `${index * 0.1}s`
                                }}
                            >
