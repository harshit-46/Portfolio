...
const Header = ({ scrollToSection, refs }) => {
    ...
    return (
        <header className="navbar-main bg-black sticky top-0 z-50 ">
            ...
            <div
                className={`fixed top-0 right-0 h-full w-[90%] bg-black z-50 px-6 pt-4 pb-6 flex flex-col items-start space-y-6 shadow-xl transform transition-transform duration-300 ${isMenuOpen ? 'translate-x-0' : 'translate-x-full'
                    }`}
            >
                <button onClick={() => handleClick(refs.homeRef)} aria-label="Go to Home">
                    <img src={AppLogo} height="60" width="60" alt="App logo" />
                </button>
