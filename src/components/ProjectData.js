...
const projectList = [
    {
        ...
        technologies: ['React.js', 'JavaScript', 'Tailwind CSS', 'Framer', 'Responsive Design', 'Algorithm Implementation' , 'Express.js' , 'Mongo DB'],
    ...
    },
    {
        ...
        technologies: ['React.js', 'News API', 'Context API', 'React Router', 'Tailwind CSS', 'Responsive Design', 'API Integration'],
        liveUrl: '',
    ...
    },
    {
        ...
        technologies: ['Node.js', 'AST Parsing', 'Monaco Editor', 'Express.js', 'Language Grammars', 'Compiler Design', 'Algorithm Optimization' , 'React.js' , 'Tailwind CSS'],
        liveUrl: '',
    ...
    },
    {
        ...
        technologies: ['React.js', 'JavaScript', 'Regular Expressions', 'Custom Hooks', 'Tailwind CSS', 'Text Processing Algorithms' ,'Node.js'],
        liveUrl: '',
    ...
    },
    {
        ...
        technologies: ['React.js', 'Node.js', 'Socket.io', 'MongoDB', 'JWT Authentication', 'Express.js', 'Real-time Communication' , 'Tailwind CSS'],
        liveUrl: '',
    ...
    },
    {
        ...
        technologies: ['React.js', 'Node.js', 'Express.js', 'MongoDB', 'Rich Text Editor', 'RESTful APIs', 'JWT Authentication', 'Full-text Search' , 'Tailwind CSS'],
        liveUrl: '',
